...
loop do
  page = MembersListPage.new(response: Scraped::Request.new(url: url, strategies: [ArchiveStrategy]).response(decorators: [ArchiveDecorator, AbsoluteLinks, RemoveSessionInformationFromLinks]))
